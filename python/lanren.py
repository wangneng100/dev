...
def is_morning_bearish(today_bar, percentage):
	print("Morning variation is: " + str((today_bar['Open'].values[1] - today_bar['Open'].values[0]) / today_bar['Open'].values[0]))
...
def is_afternoon_bullish(today_bar, percentage):
	print("Afternoon variation is: " + str((today_bar['Close'].values[-1] - today_bar['Open'].values[-3]) / today_bar['Open'].values[-3]))
